...
public class StockStream {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //4.设置检查点机制 ,在开发的时候关闭检查点(本地开发和测试), 生产环境时候一定要打开
//        env.enableCheckpointing(5000L); //开启检查点,设置检查点自动间隔时间5s
//        env.setStateBackend(new FsStateBackend("hdfs://node01:8020/checkpoint/stock"));//设置检查的存储位置hdfs
//        env.setStateBackend(new FsStateBackend("file:///D:\\export\\servers\\tmp\\checkpoint"));//设置检查的存储位置:本地
...
//        szseFilterData.print("szseFilterData:>>>>>");
