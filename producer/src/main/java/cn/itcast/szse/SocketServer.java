...
public class SocketServer {
    ...
    private static List<String> parseFile() {
        ...
        try {
            //1.读取本地源数据
            //本地磁盘路径
            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("D:\\BaiduYunDownload\\1.黑马23期大数据\\2.大数据部分\\4.Flink\\23-今日指数\\今日指数课堂资料\\今日指数-210130\\第1章\\4.资料\\需求文档\\数据源接口文档\\数据源文件\\szse.txt")),"UTF-8"));
            //服务器磁盘路径
//            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("//export//servers//tmp//socket//szse.txt")),"UTF-8"));
            ...
            while ((str = br.readLine()) != null) {
                ...
                builder.append(arr[0].trim()).append(sp)
                        ...
                        .append(System.currentTimeMillis()); //事件时间
